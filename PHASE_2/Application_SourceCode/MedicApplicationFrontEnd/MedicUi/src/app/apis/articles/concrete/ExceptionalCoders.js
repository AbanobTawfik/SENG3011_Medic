...
var ExceptionalCoders = /** @class */ (function (_super) {
    ...
    function ExceptionalCoders() {
        return _super.call(this, "https://us-central1-seng3011-859af.cloudfunctions.net", "/app/api/v1/articles") || this;
    }
    ////////////////////////////////////////////////////////////////////
    // Building a Request
    ExceptionalCoders.prototype.makeQueryString = function (startDate, endDate, keyTerms, location) {
