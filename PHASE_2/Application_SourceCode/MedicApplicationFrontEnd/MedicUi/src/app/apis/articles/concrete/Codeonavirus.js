...
var Codeonavirus = /** @class */ (function (_super) {
    ...
    function Codeonavirus() {
        return _super.call(this, "https://www.codeonavirus.com", "/who/articles") || this;
    }
    ////////////////////////////////////////////////////////////////////
    // Building a Request
    ...
    Codeonavirus.prototype.makeQueryString = function (startDate, endDate, keyTerms, location) {
        return '';
    };
    Codeonavirus.prototype.makeBody = function (startDate, endDate, keyTerms, location) {
        var body = {
