...
var APIdemic = /** @class */ (function (_super) {
    ...
    function APIdemic() {
        var _this = _super.call(this, "http://api-demic.herokuapp.com", "/v1.1/articles") || this;
        _this.name = 'ApiDemic';
        _this.limit = 250;
        return _this;
    }
    ////////////////////////////////////////////////////////////////////
    // Building a Request
    APIdemic.prototype.makeQueryString = function (startDate, endDate, keyTerms, location, pageNumber) {
    ...
    APIdemic.prototype.toStandardLocation = function (resLocation) {
        return new StandardLocation_1["default"](resLocation['country'], resLocation['location']);
    };
    ////////////////////////////////////////////////////////////////////
    APIdemic.prototype.getNextParameters = function (startDate, endDate, articles) {
        var a = articles[articles.length - 1];
        var lastDate = dateUtils_1["default"].xStrToDateFloor(a.dateOfPublication);
        var newStartDate = lastDate.add(1, 's');
        return {
