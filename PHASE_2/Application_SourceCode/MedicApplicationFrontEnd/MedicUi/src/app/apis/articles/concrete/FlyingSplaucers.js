...
var FlyingSplaucers = /** @class */ (function (_super) {
    ...
    function FlyingSplaucers() {
        return _super.call(this, "https://us-central1-flyingsplaucers-7b3cf.cloudfunctions.net", "/reports/reports") || this;
    }
    ////////////////////////////////////////////////////////////////////
    // Building a Request
    FlyingSplaucers.prototype.makeQueryString = function (startDate, endDate, keyTerms, location) {
