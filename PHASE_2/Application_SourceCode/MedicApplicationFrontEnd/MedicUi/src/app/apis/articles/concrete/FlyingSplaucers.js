...
var FlyingSplaucers = /** @class */ (function (_super) {
    ...
    function FlyingSplaucers() {
        var _this = _super.call(this, "https://us-central1-flyingsplaucers-7b3cf.cloudfunctions.net", "/reports/reports") || this;
        _this.name = 'FlyingSplaucers';
        return _this;
    }
    ////////////////////////////////////////////////////////////////////
    // Building a Request
    FlyingSplaucers.prototype.makeQueryString = function (startDate, endDate, keyTerms, location, pageNumber) {
