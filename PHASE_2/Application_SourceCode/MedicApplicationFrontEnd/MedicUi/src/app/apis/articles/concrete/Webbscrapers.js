...
var Webbscrapers = /** @class */ (function (_super) {
    ...
    function Webbscrapers() {
        var _this = _super.call(this, "https://webbscrapers.live", "/reports") || this;
        _this.name = 'Webbscrapers';
        return _this;
    }
    ////////////////////////////////////////////////////////////////////
    // Building a Request
    Webbscrapers.prototype.makeQueryString = function (startDate, endDate, keyTerms, location, pageNumber) {
